...
def is_mel(name, email):
    ...
    True
    >>> is_mel("Jenny", "mel@ubermelon.com")
    True
    >>> is_mel("Mel Melitpolski", "dog@gmail.com")
    True
    >>> is_mel("Georgia", "georgia.schmitt@gmail.com")
    False
    >>> is_mel("Mel", "bad@gmail.com")
    True
...
def most_and_least_common_type(treats):
    ...
    >>> treats = [{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'drink'}, {'type': 'dessert'}, {'type': 'drink'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'appetizer')

    >>> treats = [{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'drink'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'appetizer')
